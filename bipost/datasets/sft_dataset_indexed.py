...
class SFTDatasetIndexed(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Squeeze the batch dimension to get (seq_length) instead of (1, seq_length)
        return ide, prompt_ids_len, input_token["input_ids"].squeeze(0), input_token["attention_mask"].squeeze(0), info
